...
## Preprocessing parameter to do it or no
do_preprocessing = True # preprocessing process always save files and calculate Hau(Or<->Simp)
...
## After preprocessing parameter
calculate_metrics = True # Hau(Or <-> Opt), max_error(Or <-> Opt) and avg_error(Or <-> Opt)
